      ...
      <div className="w-full max-w-[500px] bg-white p-8 md:p-10 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              type="email"
              className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-gray-700 placeholder-gray-400 text-sm transition-colors ${emailError
