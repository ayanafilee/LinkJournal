      ...
      <div className="w-full max-w-[500px] bg-white p-8 md:p-10 rounded-xl shadow-sm">
        ...
        <div className="flex gap-4 mb-4">
          <div className="w-1/2">
            ...
            <input
              type="text"
              className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-gray-700 placeholder-gray-400 text-sm ${firstNameError
          ...
          <div className="w-1/2">
            ...
            <input
              type="text"
              className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-gray-700 placeholder-gray-400 text-sm ${lastNameError
                ? "border-red-500 focus:ring-red-200"
                : "border-gray-200 focus:ring-blue-500"
                }`}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              type="email"
              className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-gray-700 placeholder-gray-400 text-sm ${emailError
                ? "border-red-500 focus:ring-red-200"
                : "border-gray-200 focus:ring-blue-500"
                }`}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-10 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-gray-700 placeholder-gray-400 text-sm transition-colors ${passwordError
                ? "border-red-500 focus:ring-red-200"
                : "border-gray-200 focus:ring-blue-500"
                }`}
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-10 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent text-gray-700 placeholder-gray-400 text-sm transition-colors ${confirmPasswordError
                ? "border-red-500 focus:ring-red-200"
                : "border-gray-200 focus:ring-blue-500"
                }`}
